<?php class LoginRadiusWidget extends WP_Widget {
	...
	function LoginRadiusWidget() {
		parent::WP_Widget(
			...
			array( 
				'description' => __( 'Connectez-vous ou enregistrez-vous avec Facebook, Twitter, Yahoo, Google et bien d\'autres', 'LoginRadius' ))
			);
	}
	...
	$defaults = array( 'title' => $title, 'before_widget_content' => '', 'after_widget_content' => '' );
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Titre:', 'LoginRadius' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" />
			<label for="<?php echo $this->get_field_id( 'before_widget_content' ); ?>"><?php _e( 'Avant le contenu du widget:', 'LoginRadius' ); ?></label>
			...
			<label for="<?php echo $this->get_field_id( 'after_widget_content' ); ?>"><?php _e( 'Une fois le contenu du widget:', 'LoginRadius' ); ?></label>
			...
			<br /><br /><label for="<?php echo $this->get_field_id( 'hide_for_logged_in' ); ?>"><?php _e( 'Cacher pour les utilisateurs connecte`s:', 'LoginRadius' ); ?> </label>
